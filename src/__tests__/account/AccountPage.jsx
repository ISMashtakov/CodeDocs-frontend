...
it('ChangePasswordWindow open change username', async () => {
  await act(async () => {
    render(
      <CustomSnackbarProvider>
        <Provider store={store}>
...
it('ChangePasswordWindow open change email', async () => {
  await act(async () => {
    render(
      <CustomSnackbarProvider>
        <Provider store={store}>
...
it('ChangePasswordWindow open change password', async () => {
  await act(async () => {
    render(
      <CustomSnackbarProvider>
        <Provider store={store}>
...
it('ChangePasswordWindow logout', async () => {
