...
it('test receiveOperation', () => {
  ...
  expect(textEditor.approvedOperations).toEqual([new StorageOperation(op3, StorageOperation.TYPES.ALIEN)])
...
// it('test applyNotApplyedOperations', () => {
//     const sendOperationMessage = jest.spyOn(actions, 'requestOperationHistory').mockImplementation(simpleFetch());

//     const op1 = new Insert(0, 'hello');
//     const op2 = new Insert(3, "cat")
//     const op3 = new Insert(0, "dog")
//     const op4 = new Insert(0, "kitty")
//     textEditor.receivedNotApplydOperations = {
//       1: op1,
//       2: op2,
//       3: op3,
//       6: op4,
//     }
//     textEditor.revision = 2;

//     textEditor.applyNotApplyedOperations()

//     expect(textEditor.revision).toEqual(3)
//     expect(textEditor.text).toEqual("dog")
